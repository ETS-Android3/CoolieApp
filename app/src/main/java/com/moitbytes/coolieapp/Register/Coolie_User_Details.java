...
//        });
                        ...
                        if (task.isSuccessful())
                        {
                        ...
                        else
                            {
                                if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                    Toast.makeText(Coolie_User_Details.this, "Incorrect OTP entered", Toast.LENGTH_LONG).show();
                                    user_otp.setText("");

                                } else {
                                    Toast.makeText(Coolie_User_Details.this, "Unable to verify please retry later", Toast.LENGTH_LONG).show();
    ...
    private void sendVerificationCode(String number) {
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setActivity(Coolie_User_Details.this)                 // Activity (for callback binding)
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
            ...
            verificationId = s;
            user_otp.setEnabled(false);
            user_otp.setHint("Waiting for otp...");
        }
        ...
        public void onCodeAutoRetrievalTimeOut(@NonNull String s) {
            ...
            progressBar.setVisibility(View.GONE);
            user_otp.setEnabled(true);
            user_otp.setHint("Enter OTP");
